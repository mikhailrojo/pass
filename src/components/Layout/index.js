...
const menuInfo = [
	...
	`Я не прошу говорить мне ваш логин или емейл, я вообще о вас ничего не знаю.
	Для меня вы - полный аноним, и у меня нет информации, где его использовать.`,
